...
void setup()
{
    ...
    // na tu wi-fi se v mobilu musim prihlasit a potom zapnout RBControl, vyplnit majitele -> Mirek
    // a pak po najeti stranky Ovladani na ni poklepat -> objevi se ovladani, ktere chci

    // Initialize RBProtocol
    gProt = new Protocol("Mirek", "Ovladani", "Compiled at " __DATE__ " " __TIME__, onPacketReceived);
    gProt->start();
